...
class EAGLEPlatform {
    constructor(log, config, api) {
        ...
        this.client = new eagleClient_1.EagleClient(eagleConfig.host, eagleConfig.cloudId, eagleConfig.installCode, log);
    ...
    registerOrRestoreAccessory(meterAddress) {
        ...
        if (existingAccessory) {
            ...
            this.gridMeterAccessory = new gridMeterAccessory_1.GridMeterAccessory(this, existingAccessory, FakeGatoHistoryService);
        }
        else {
            ...
            this.gridMeterAccessory = new gridMeterAccessory_1.GridMeterAccessory(this, accessory, FakeGatoHistoryService);
